...
const { getDirections, createDirection, updateLorryDetails, findAssignedDirection, updateDriverResponse, updateCurrentLocation, removeDirection, getDirectionByVehicleId, ignoreTripByDriver, startTripByDriver } = require("../controllers/direction.controller");
